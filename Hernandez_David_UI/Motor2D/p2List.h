...
void InsertAfter(uint position, const tdata data)
{
	p2List_item<tdata>* prevItem = At(position);
	p2List_item<tdata>* nextItem = At(position+1);

	p2List_item<tdata>* newItem = new p2List_item<tdata>(data);
