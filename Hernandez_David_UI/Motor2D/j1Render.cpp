...
bool j1Render::PreAwake(pugi::xml_node& config)
{
...
bool j1Render::Blit(SDL_Texture* texture, const SDL_Rect* onScreenPosition, const SDL_Rect* section, float speed, double angle, int pivot_x, int pivot_y) const
{
	bool ret = true;
	uint scale = App->win->GetScale();
...
bool j1Render::DrawQuad(const SDL_Rect& rect, Uint8 r, Uint8 g, Uint8 b, Uint8 a, bool filled) const
{
	bool ret = true;
	uint scale = App->win->GetScale();
...
bool j1Render::DrawLine(int x1, int y1, int x2, int y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a) const
{
	bool ret = true;
	uint scale = App->win->GetScale();
...
bool j1Render::DrawCircle(int x, int y, int radius, Uint8 r, Uint8 g, Uint8 b, Uint8 a) const
{
	bool ret = true;
	uint scale = App->win->GetScale();
